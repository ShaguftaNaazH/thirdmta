		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "northwind third",
									"targetURL": "#compracticethirdmtafiori-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"compracticethirdmtafiori-display": {
								"semanticObject": "compracticethirdmtafiori",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.practice.thirdmtafiori",
									"url": sap.ui.require.toUrl("com/practice/thirdmtafiori")
								}
							}
						}
					}
